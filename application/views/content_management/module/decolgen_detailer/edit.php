<div class="box">
    ...
    <div class="box-body">
        ...
        if (!$this->uri->segment(4) === NULL || !empty($this->uri->segment(4))) {
            $details = $this->load->details("pckg_decolgen_detailer", $this->uri->segment(4));
            $inputs = ["image","description","status"];
            $values = [$details[0]->image,$details[0]->description,$details[0]->status];
                ...
                if(result){
                    ...
                    AJAX.update.exec(function(result){
                        ...
                        modal.alert("<?= $this->standard->dialog("update_success"); ?>", function(){
                            location.href = '<?=base_url("content_management/site_decolgen_detailer") ?>';
                        });
                    })
                }
            });
