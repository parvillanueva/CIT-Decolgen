<div class="box">
    ...
    <div class="box-body">
        ...
        if (!$this->uri->segment(4) === NULL || !empty($this->uri->segment(4))) {
            ...
            $inputs = ["landing_title","sub_title","landing_asc","landing_bg_img","landing_image_banner","landing_logo_image","landing_description","landing_redirect_url","status"];
            $values = [$details[0]->title,$details[0]->sub_title,$details[0]->landing_asc,$details[0]->landing_bg,$details[0]->image_banner,$details[0]->landing_logo,$details[0]->description,$details[0]->redirect_url,$details[0]->status,$details[0]->status];
