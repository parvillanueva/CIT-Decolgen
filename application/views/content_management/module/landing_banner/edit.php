<div class="box">
    ...
    <div class="box-body">
        ...
        if (!$this->uri->segment(4) === NULL || !empty($this->uri->segment(4))) {
            ...
            $values = [$details[0]->title,$details[0]->sub_title,$details[0]->landing_asc,$details[0]->landing_bg,$details[0]->image_banner,$details[0]->landing_logo,$details[0]->description,$details[0]->redirect_link,$details[0]->status,$details[0]->status];
