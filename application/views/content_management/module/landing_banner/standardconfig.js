var input_id = ["title","image_banner","description","redirect_url"];
var input_class = {input_class};
var input_maxlength = ["255","255"];
var input_note = ["","","",""];
var required_field = ["1","1","1","1"];
var input_label = ["title","image_banner","description","redirect_url"];
var input_count = 4;
var text_label = ["Title","Image Banner","Description","Redirect URL"];
var text_placeholder = ["Title","Image Banner","Description","Redirect URL"];
