var input_id = ["title","brief_description","image_banner"];
var input_class = {input_class};
var input_maxlength = ["255","255"];
var input_note = ["","",""];
var required_field = ["1","1","1"];
var input_label = ["title","brief_description","image_banner"];
var input_count = 3;
var text_label = ["Title","Brief Description","Image Banner"];
var text_placeholder = ["Title","Brief Description","Image Banner"];
