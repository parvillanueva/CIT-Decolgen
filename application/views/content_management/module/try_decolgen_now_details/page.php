<div class="box">
    ...
    <div class="box-body">
    	<?php 
        $details = $this->load->details("pckg_try_decolgen_now_details", 1);
        if ($this->uri->segment(4) !== NULL || !empty($this->uri->segment(4))) {
            $inputs = ["try_decolgen_title","try_decolgen_brief_des"];
            $values = [$details[0]->try_decolgen_title,$details[0]->try_decolgen_brief_des];
        ...
        if(validate.standard("<?= $id; ?>")){
            ...
            modal.standard(modal_obj, function(result){
                if(result){
                    ...
                    AJAX.update.table("pckg_try_decolgen_now_details");
