var input_id = ["title","image","description"];
var input_class = {input_class};
var input_maxlength = ["255","255"];
var input_note = ["","",""];
var required_field = ["1","1","1"];
var input_label = ["title","image","description"];
var input_count = 3;
var text_label = ["Title","Image","Description"];
var text_placeholder = ["Title","Image","Description"];
