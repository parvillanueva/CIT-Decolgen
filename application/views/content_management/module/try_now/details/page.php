<div class="box">
    ...
    <div class="box-body">
        ...
        if ($this->uri->segment(4) !== NULL || !empty($this->uri->segment(4))) {
            ...
            $values = [$details[0]->title,$details[0]->sub_title,$details[0]->image_banner,$details[0]->background_image,$details[0]->background_image_two,$details[0]->image_banner_product,$details[0]->image_banner_details,$details[0]->image_details,$details[0]->first_title,$details[0]->first_description,$details[0]->second_title,$details[0]->second_description];
