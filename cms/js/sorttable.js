...
jQuery.fn.addSortWidget = function(options){
	var defaults = {
		img_asc: ""+sortable_base_url+"cms/images/sort_asc.png",	
		img_desc: ""+sortable_base_url+"cms/images/sort_desc.png",	
		img_nosort: ""+sortable_base_url+"cms/images/sort_both.png",		
	};
